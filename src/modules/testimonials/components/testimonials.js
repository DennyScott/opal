            ...
            <Slider {...settings} className="tms-slides">
              <div className="tms-item">
                <div className="tms-icons">
                  <h2>
                    <span className="icon icon-basic-message-multiple" />
                  </h2>
                </div>
              ...
              <div className="tms-item">
                ...
                <div className="tms-content">
                  <blockquote>
                    <p>
                      “If you want to know what a mans like, take a good look at
              ...
              <div className="tms-item">
                ...
                <div className="tms-content">
                  <blockquote>
                    <p>
                      “It’s all that Ocarina kid’s fault! Next time he comes
                      around here, I’m gonna mess him up!”
                    </p>
                  </blockquote>
                </div>
                <div className="tms-author">
